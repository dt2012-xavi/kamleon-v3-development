...
class NotificationListItemView : LinearLayout {

    private var view: View =
        LayoutInflater.from(context).inflate(R.layout.layout_notification_list_item, this, true)
